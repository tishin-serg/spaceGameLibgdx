package ru.tishin.starGame.screen.utils;
...
/*
Занимается загрузкой, освобождением ресурсов
 */
...
public class Assets {
    ...
    /*
    Загружает ресурсы в зависимости от экрана
     */
    public void loadAssets(ScreenManager.ScreenType type) {
        switch (type) {
            case GAME:
                ...
                assetManager.finishLoading(); // дождись конца загрузки
